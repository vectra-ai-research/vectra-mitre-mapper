...
def get_attack_version(domain, version):
    ...
    ms = MemoryStore()
    ms.load_from_file(os.path.join("Resources/attack-stix-data-master",domain, f"{domain}-{version}.json"))
    return ms
...
#tool:group
def tools_used_by_groups(thesrc):
    ...
    software_used_by_group = {**tools_used_by_group} # group_id -> {software, relationship}
    ...
    campaigns_attributed_to_group = {
        ...
        "software": tools_used_by_campaign # campaign_id => {software, relationship}
    }
